...
class FeatureBinRegression:
    def __init__(self, args):
        self.process = 'FeatureBinRegression'
    ...
    def load_and_validate(self):
        ...
        eeg = {}
        iterator = tqdm(eeg_filtered.groupby('time_bin'), total=eeg_filtered.time_bin.nunique(), desc='EEG to numpy')
        time_map = {}
...
def main():
    ...
    parser.add_argument('--out_dir', '-o', type=str, help='directory for outputs',
                        default='/home/emcmaho7/scratch4-lisik3/emcmaho7/SIEEG_analysis/data/interim/FeatureBinRegression')
