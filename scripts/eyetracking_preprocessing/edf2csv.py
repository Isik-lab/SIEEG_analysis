...
new = df.copy()
new['run_block'] = df.run.astype('str') + '_' + df.block.astype('str')
print(f'number of samples = {len(df)}')
print(f'block data = {new.run_block.unique()}')
print(df.dtypes)
df.to_csv(f'processed_data/SIdyads_alltrials/{subj}.csv', index=False)
shutil.copy(f'processed_data/SIdyads_alltrials/{subj}.csv', f'../SIfMRI_analysis/data/raw/eyetracking/{subj}.csv')
